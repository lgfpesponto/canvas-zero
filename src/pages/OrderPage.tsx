        ...
        if (itemsZerados.length > 0 && forceEstoquePronto) {
          ...
          const rowsToInsert = itemsZerados.map(it => ({
            ...
            ficha_snapshot: {
              ...
              // Bordados (+ cores e desc variado)
              bordado_cano: (orderData as any).bordadoCano || null,
              bordado_gaspea: (orderData as any).bordadoGaspea || null,
              bordado_taloneira: (orderData as any).bordadoTaloneira || null,
              cor_bordado_cano: (orderData as any).corBordadoCano || null,
              cor_bordado_gaspea: (orderData as any).corBordadoGaspea || null,
              cor_bordado_taloneira: (orderData as any).corBordadoTaloneira || null,
              bordado_variado_desc_cano: (orderData as any).bordadoVariadoDescCano || null,
              bordado_variado_desc_gaspea: (orderData as any).bordadoVariadoDescGaspea || null,
              bordado_variado_desc_taloneira: (orderData as any).bordadoVariadoDescTaloneira || null,
              // Recortes
              recorte_cano: (orderData as any).recorteCano || null,
              recorte_gaspea: (orderData as any).recorteGaspea || null,
              recorte_taloneira: (orderData as any).recorteTaloneira || null,
              cor_recorte_cano: (orderData as any).corRecorteCano || null,
              cor_recorte_gaspea: (orderData as any).corRecorteGaspea || null,
              cor_recorte_taloneira: (orderData as any).corRecorteTaloneira || null,
              // Personalização / nome
              personalizacao_nome: (orderData as any).personalizacaoNome || null,
              personalizacao_bordado: (orderData as any).personalizacaoBordado || null,
              nome_bordado_desc: (orderData as any).nomeBordadoDesc || null,
              // Laser + Glitter
              tem_laser: (orderData as any).temLaser || false,
              laser_cano: (orderData as any).laserCano || null,
              laser_gaspea: (orderData as any).laserGaspea || null,
              laser_taloneira: (orderData as any).laserTaloneira || null,
              cor_glitter_cano: (orderData as any).corGlitterCano || null,
              cor_glitter_gaspea: (orderData as any).corGlitterGaspea || null,
              cor_glitter_taloneira: (orderData as any).corGlitterTaloneira || null,
              // Pintura / estampa
              pintura: (orderData as any).pintura || null,
              pintura_desc: (orderData as any).pinturaDesc || null,
              estampa: (orderData as any).estampa || null,
              estampa_desc: (orderData as any).estampaDesc || null,
              // Extras diversos
              trisce: (orderData as any).trisce || null,
              trice_desc: (orderData as any).triceDesc || null,
              tiras: (orderData as any).tiras || null,
              tiras_desc: (orderData as any).tirasDesc || null,
              costura_atras: (orderData as any).costuraAtras || null,
              // Metais
              metais: (orderData as any).metais || null,
              tipo_metal: (orderData as any).tipoMetal || null,
              cor_metal: (orderData as any).corMetal || null,
              strass_qtd: (orderData as any).strassQtd || 0,
              cruz_metal_qtd: (orderData as any).cruzMetalQtd || 0,
              bridao_metal_qtd: (orderData as any).bridaoMetalQtd || 0,
              // Acessórios / Desenvolvimento / Sob Medida
              acessorios: (orderData as any).acessorios || null,
              desenvolvimento: (orderData as any).desenvolvimento || null,
              sob_medida: (orderData as any).sobMedida || false,
              sob_medida_desc: (orderData as any).sobMedidaDesc || null,
              // Pesponto / Carimbo / Vivo / Forma
              cor_linha: (orderData as any).corLinha || null,
              cor_borrachinha: (orderData as any).corBorrachinha || null,
              cor_vivo: (orderData as any).corVivo || null,
              forma: (orderData as any).forma || null,
              carimbo: (orderData as any).carimbo || null,
              carimbo_desc: (orderData as any).carimboDesc || null,
              // Adicional
              adicional_valor: (orderData as any).adicionalValor || 0,
              adicional_desc: (orderData as any).adicionalDesc || null,
              // Bloco extra (franja/corrente/cavalo/desenv*)
              extra_detalhes: (orderData as any).extraDetalhes || {},
            },
            ativo: true,
          }));
