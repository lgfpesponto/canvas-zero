  ...
  const renderFernandaDashboard = () => (
    <section className="container mx-auto px-4 py-8">
      <motion.div initial="hidden" animate="visible" variants={fadeIn} custom={0}>
        <SpecializedReports reports={['escalacao', 'forro', 'palmilha', 'pesponto', 'bordados', 'expedicao', 'extras_cintos']} />
      </motion.div>
    </section>
  );
    ...
    <section className="container mx-auto px-4 py-8">
      ...
      <div className="mt-8">
        <motion.div initial="hidden" animate="visible" variants={fadeIn} custom={3}>
          <SpecializedReports reports={['escalacao', 'forro', 'palmilha', 'pesponto', 'bordados', 'expedicao', 'cobranca', 'extras_cintos']} />
        </motion.div>
      </div>
    </section>
  );
