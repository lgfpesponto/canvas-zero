...
DROP FUNCTION IF EXISTS public.excluir_estoque_produto_completo(text);
...
GRANT EXECUTE ON FUNCTION public.excluir_estoque_produto_completo(uuid[]) TO authenticated;
